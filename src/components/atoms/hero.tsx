      ...
      >
        <div>
          ...
          >
            ...
            <MagneticButton
              href="#contact"
              className="btn-magnetic inline-flex items-center gap-2 rounded-full border border-foreground text-white text-sm font-medium px-6 py-3.5 hover:opacity-90 transition-opacity"
            >
              {t("cta.contactMe")}
            </MagneticButton>
          </motion.div>
